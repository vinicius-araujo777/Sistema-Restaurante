...
<div class="bg-white rounded-xl border border-gray-200 p-6">
    <div class="flex justify-between items-center mb-5">
        <h2 class="text-base font-semibold text-gray-900">Lista de Pratos</h2>
        <a href="inserir.php" class="bg-orange-500 hover:bg-orange-600 text-white text-sm px-4 py-2 rounded-lg transition">+ Adicionar Prato</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="py-3">
                        <div class="flex gap-1">
                            <a href="editar.php?id=<?= $prato->id ?>" class="text-orange-500 hover:underline px-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>

                            <a href="excluir.php?id=<?= $prato->id ?>" onclick="return confirm('Excluir?')" class="text-red-400 hover:underline px-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
