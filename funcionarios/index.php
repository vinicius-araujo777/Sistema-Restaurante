...
<div class="bg-white rounded-xl border border-gray-200 p-6">
    <div class="flex justify-between items-center mb-5">
        <h2 class="text-base font-semibold text-gray-900">Lista de funcionários</h2>
        <a href="inserir.php" class="bg-orange-500 hover:bg-orange-600 text-white text-sm px-4 py-2 rounded-lg transition">+ Adicionar funcionarios</a>
    </div>
            ...
            <tr>
                ...
                <td class="py-3">
                    <div class="flex gap-1">
                        ...
                        <a href="excluir.php?id=<?= $f->id ?>" class="text-red-400 hover:bg-red-50 p-1.5 rounded-lg transition" onclick="return confirm('Excluir este funcionário?')"> 
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
