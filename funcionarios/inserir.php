...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(adicionarFuncionario($con, $nome, $cargo, $salario)) {
        ...
        $erro = "Erro ao adicionar funcionario";
    }
};
...
<div class="mb-10 text-center">
    <h1 class="text-3xl font-bold text-gray-900">Adicionar funcionário</h1>
    <p class="text-base text-gray-500"> Preencha os dados do novo funcionário</p>
</div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-8 max-w-3xl w-full shadow-sm">
        ...
        <form action="" method="post" class="space-y-6">
            <div>
                ...
                <input type="text" name="nome" placeholder="Ex: Vinicius Araújo" required
            ...
            <div>
                ...
                <input type="number" name="salario" step="0.01" placeholder="Ex: 2500.00" required
                    class="w-full border border-gray-200 rounded-lg px-3 py-3 text-sm text-gray-800 outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition">
            </div>
